...
public abstract class c {
    ...
    public static final String[] f5850a = new String[0];
    ...
    public static void a(EditorInfo editorInfo, CharSequence charSequence) {
        ...
        if (i10 >= 0 && i13 <= length) {
            ...
            if (i15 != 129 && i15 != 225 && i15 != 18) {
                ...
                int i20 = i19 + min;
                if (i11 != i16) {
                    charSequence2 = TextUtils.concat(charSequence.subSequence(i18, i18 + min2), charSequence.subSequence(i13, min + i13));
                } else {
                    charSequence2 = charSequence.subSequence(i18, i20 + i18);
                }
                b(editorInfo, charSequence2, min2, i19);
                return;
            }
