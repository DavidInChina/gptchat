...
public abstract class AbstractC5949b {
    ...
    public static final void a(r0.E e10, double d10, double d11, double d12, double d13, double d14, double d15, double d16, boolean z10, boolean z11) {
        ...
        if (d31 < 0.0d) {
            ...
            a(e10, d10, d11, d12, d13, d19 * sqrt, d15 * sqrt, d16, z10, z11);
            return;
        }
        ...
        double atan2 = Math.atan2(d22 - d17, d21 - d18);
        double atan22 = Math.atan2(d24 - d17, d23 - d18) - atan2;
        ...
        while (i11 < ceil) {
            ...
            ((C5344h) e10).f44241a.cubicTo((float) ((d49 * sqrt3) + d47), (float) ((d50 * sqrt3) + d51), (float) (d54 - (sqrt3 * d56)), (float) (d55 - (sqrt3 * d57)), (float) d54, (float) d55);
            i11++;
            sin2 = d59;
            d43 = d43;
            d47 = d54;
    ...
    public static final void b(List list, r0.E e10) {
        int i10;
        AbstractC5938B abstractC5938B;
        Path path;
        C5344h c5344h;
        float f6;
        int i11;
        AbstractC5938B abstractC5938B2;
        int i12;
        float f10;
        float f11;
        float f12;
        ...
        float f21;
        List list2 = list;
        C5344h c5344h2 = (C5344h) e10;
        if (c5344h2.f44241a.getFillType() == Path.FillType.EVEN_ODD) {
            i10 = 1;
        } else {
            i10 = 0;
        }
        Path path2 = c5344h2.f44241a;
        path2.rewind();
        c5344h2.e(i10);
        if (list.isEmpty()) {
            abstractC5938B = C5957j.f46979c;
        } else {
            abstractC5938B = (AbstractC5938B) list2.get(0);
        }
        int size = list.size();
        float f22 = 0.0f;
        int i13 = 0;
        ...
        float f28 = 0.0f;
        while (i13 < size) {
            AbstractC5938B abstractC5938B3 = (AbstractC5938B) list2.get(i13);
            if (abstractC5938B3 instanceof C5957j) {
                path2.close();
                path2.moveTo(f28, f27);
                f24 = f27;
                f26 = f24;
                abstractC5938B2 = abstractC5938B3;
                i12 = i13;
                f23 = f28;
                f25 = f23;
            } else {
                if (abstractC5938B3 instanceof v) {
                    v vVar = (v) abstractC5938B3;
                    float f29 = vVar.f47017c;
                    f23 += f29;
                    float f30 = vVar.f47018d;
                    f24 += f30;
                    path2.rMoveTo(f29, f30);
                    f28 = f23;
                    f27 = f24;
                } else if (abstractC5938B3 instanceof n) {
                    n nVar = (n) abstractC5938B3;
                    f23 = nVar.f46989c;
                    float f31 = nVar.f46990d;
                    path2.moveTo(f23, f31);
                    f24 = f31;
                    f27 = f24;
                    f28 = f23;
                } else if (abstractC5938B3 instanceof u) {
                    u uVar = (u) abstractC5938B3;
                    float f32 = uVar.f47015c;
                    float f33 = uVar.f47016d;
                    path2.rLineTo(f32, f33);
                    f23 += uVar.f47015c;
                    f24 += f33;
                } else {
                    if (abstractC5938B3 instanceof m) {
                        m mVar = (m) abstractC5938B3;
                        float f34 = mVar.f46987c;
                        f24 = mVar.f46988d;
                        c5344h2.b(f34, f24);
                        f21 = mVar.f46987c;
                    } else if (abstractC5938B3 instanceof t) {
                        t tVar = (t) abstractC5938B3;
                        path2.rLineTo(tVar.f47014c, f22);
                        f23 += tVar.f47014c;
                    } else if (abstractC5938B3 instanceof l) {
                        l lVar = (l) abstractC5938B3;
                        c5344h2.b(lVar.f46986c, f24);
                        f21 = lVar.f46986c;
                    } else if (abstractC5938B3 instanceof z) {
                        z zVar = (z) abstractC5938B3;
                        path2.rLineTo(f22, zVar.f47029c);
                        f24 += zVar.f47029c;
                    } else if (abstractC5938B3 instanceof C5937A) {
                        C5937A c5937a = (C5937A) abstractC5938B3;
                        c5344h2.b(f23, c5937a.f46840c);
                        f24 = c5937a.f46840c;
                    } else {
                        if (abstractC5938B3 instanceof s) {
                            s sVar = (s) abstractC5938B3;
                            f10 = f27;
                            c5344h2.f44241a.rCubicTo(sVar.f47008c, sVar.f47009d, sVar.f47010e, sVar.f47011f, sVar.f47012g, sVar.f47013h);
                            f13 = sVar.f47010e + f23;
                            f14 = sVar.f47011f + f24;
                            f23 += sVar.f47012g;
                            f24 += sVar.f47013h;
                        } else {
                            f10 = f27;
                            if (abstractC5938B3 instanceof C5958k) {
                                C5958k c5958k = (C5958k) abstractC5938B3;
                                c5344h2.f44241a.cubicTo(c5958k.f46980c, c5958k.f46981d, c5958k.f46982e, c5958k.f46983f, c5958k.f46984g, c5958k.f46985h);
                                f15 = c5958k.f46982e;
                                f16 = c5958k.f46983f;
                                f17 = c5958k.f46984g;
                                f18 = c5958k.f46985h;
                            } else {
                                if (abstractC5938B3 instanceof x) {
                                    if (abstractC5938B.f46841a) {
                                        f20 = f23 - f25;
                                        f19 = f24 - f26;
                                    } else {
                                        f20 = 0.0f;
                                    ...
                                    x xVar = (x) abstractC5938B3;
                                    c5344h2.f44241a.rCubicTo(f20, f19, xVar.f47023c, xVar.f47024d, xVar.f47025e, xVar.f47026f);
                                    float f35 = xVar.f47023c + f23;
                                    float f36 = xVar.f47024d + f24;
                                    f23 += xVar.f47025e;
                                    f24 += xVar.f47026f;
                                    f26 = f36;
                                    abstractC5938B2 = abstractC5938B3;
                                    ...
                                    f6 = 0.0f;
                                    f25 = f35;
                                } else if (abstractC5938B3 instanceof p) {
                                    if (abstractC5938B.f46841a) {
                                        float f37 = 2;
                                        f23 = (f23 * f37) - f25;
                                        f24 = (f37 * f24) - f26;
                                    }
                                    p pVar = (p) abstractC5938B3;
                                    c5344h2.f44241a.cubicTo(f23, f24, pVar.f46995c, pVar.f46996d, pVar.f46997e, pVar.f46998f);
                                    f15 = pVar.f46995c;
                                    f16 = pVar.f46996d;
                                    f17 = pVar.f46997e;
                                    f18 = pVar.f46998f;
                                } else if (abstractC5938B3 instanceof w) {
                                    w wVar = (w) abstractC5938B3;
                                    float f38 = wVar.f47019c;
                                    float f39 = wVar.f47020d;
                                    float f40 = wVar.f47021e;
                                    float f41 = wVar.f47022f;
                                    path2.rQuadTo(f38, f39, f40, f41);
                                    f13 = wVar.f47019c + f23;
                                    f14 = f39 + f24;
                                    f23 += f40;
                                    f24 += f41;
                                } else if (abstractC5938B3 instanceof o) {
                                    o oVar = (o) abstractC5938B3;
                                    float f42 = oVar.f46991c;
                                    float f43 = oVar.f46992d;
                                    float f44 = oVar.f46993e;
                                    float f45 = oVar.f46994f;
                                    path2.quadTo(f42, f43, f44, f45);
                                    f13 = oVar.f46991c;
                                    f26 = f43;
                                    f23 = f44;
                                    f24 = f45;
                                    ...
                                    f6 = 0.0f;
                                    f25 = f13;
                                } else if (abstractC5938B3 instanceof y) {
                                    if (abstractC5938B.f46842b) {
                                        f12 = f23 - f25;
                                        f11 = f24 - f26;
                                    } else {
                                        f12 = 0.0f;
                                    ...
                                    y yVar = (y) abstractC5938B3;
                                    float f46 = yVar.f47027c;
                                    float f47 = yVar.f47028d;
                                    path2.rQuadTo(f12, f11, f46, f47);
                                    float f48 = f12 + f23;
                                    float f49 = f11 + f24;
                                    f23 += yVar.f47027c;
                                    f24 += f47;
                                    ...
                                    f27 = f10;
                                    f6 = 0.0f;
                                } else if (abstractC5938B3 instanceof q) {
                                    if (abstractC5938B.f46842b) {
                                        float f50 = 2;
                                        f23 = (f23 * f50) - f25;
                                        f24 = (f50 * f24) - f26;
                                    }
                                    q qVar = (q) abstractC5938B3;
                                    float f51 = qVar.f46999c;
                                    float f52 = qVar.f47000d;
                                    path2.quadTo(f23, f24, f51, f52);
                                    f26 = f24;
                                    f24 = f52;
                                    abstractC5938B2 = abstractC5938B3;
                                    i12 = i13;
                                    ...
                                    f25 = f23;
                                    f23 = qVar.f46999c;
                                } else if (abstractC5938B3 instanceof r) {
                                    r rVar = (r) abstractC5938B3;
                                    float f53 = rVar.f47006h + f23;
                                    float f54 = rVar.f47007i + f24;
                                    i12 = i13;
                                    i11 = size;
                                    f6 = 0.0f;
                                    c5344h = c5344h2;
                                    path = path2;
                                    a(c5344h2, f23, f24, f53, f54, rVar.f47001c, rVar.f47002d, rVar.f47003e, rVar.f47004f, rVar.f47005g);
                                    f24 = f54;
                                    f26 = f24;
                                    f28 = f28;
                                    f27 = f10;
                                    ...
                                    path = path2;
                                    f6 = 0.0f;
                                    if (abstractC5938B3 instanceof C5956i) {
                                        C5956i c5956i = (C5956i) abstractC5938B3;
                                        float f56 = c5956i.f46978i;
                                        abstractC5938B2 = abstractC5938B3;
                                        a(c5344h, f23, f24, c5956i.f46977h, f56, c5956i.f46972c, c5956i.f46973d, c5956i.f46974e, c5956i.f46975f, c5956i.f46976g);
                                        f23 = c5956i.f46977h;
                                        f25 = f23;
                                        f28 = f55;
                                        f27 = f10;
