...
public final class C4847n implements Cg.b {

    /* renamed from: a  reason: collision with root package name */
    public final Map f40360a;

    /* renamed from: b  reason: collision with root package name */
    public final Cg.c f40361b;

    /* renamed from: c  reason: collision with root package name */
    public final Cg.i f40362c;

    /* renamed from: d  reason: collision with root package name */
    public final Cg.g f40363d;

    public C4847n(HashMap hashMap, Cg.c cVar, Cg.i iVar) {
        Cg.e eVar = Cg.e.f3126a;
        AbstractC3557B.c0("equalityAxioms", cVar);
        AbstractC3557B.c0("kotlinTypeRefiner", iVar);
        this.f40360a = hashMap;
        this.f40361b = cVar;
        this.f40362c = iVar;
        this.f40363d = eVar;
    }
    ...
    public final boolean t(Eg.i iVar, Eg.i iVar2) {
        AbstractC3557B.c0("c1", iVar);
        AbstractC3557B.c0("c2", iVar2);
        if (iVar instanceof Y) {
            if (iVar2 instanceof Y) {
                if (!AbstractC3557B.L(iVar, iVar2)) {
                    Y y10 = (Y) iVar;
                    Y y11 = (Y) iVar2;
                    if (!this.f40361b.d(y10, y11)) {
                        Map map = this.f40360a;
                        if (map != null) {
                            Y y12 = (Y) map.get(y10);
                            Y y13 = (Y) map.get(y11);
                            if ((y12 == null || !AbstractC3557B.K(y12, y11)) && (y13 == null || !AbstractC3557B.K(y13, y10))) {
                            }
                        }
                        return false;
                    }
