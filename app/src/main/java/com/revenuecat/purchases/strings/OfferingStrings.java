...
public final class OfferingStrings {
    ...
    public static final String PLACEMENTS_EMPTY_ERROR = "Error while fetching placements - no placements defined";
