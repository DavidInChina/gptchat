...
public final class PurchasesOrchestrator$restorePurchases$1$2$1$2 extends o implements n {
    ...
    public final void invoke(StoreTransaction storeTransaction, PurchasesError purchasesError) {
        ...
        AbstractC2469q0.t(new Object[]{this.$purchase, purchasesError}, 2, RestoreStrings.RESTORING_PURCHASE_ERROR, LogIntent.RC_ERROR);
