...
public final class CoroutinesExtensionsCommonKt$awaitGetProducts$2$2 extends o implements k {
    final /* synthetic */ AbstractC4825e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CoroutinesExtensionsCommonKt$awaitGetProducts$2$2(AbstractC4825e abstractC4825e) {
        super(1);
