...
public final class CoroutinesExtensionsCommonKt$awaitRestore$2$1 extends o implements k {
    final /* synthetic */ AbstractC4825e $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CoroutinesExtensionsCommonKt$awaitRestore$2$1(AbstractC4825e abstractC4825e) {
        super(1);
