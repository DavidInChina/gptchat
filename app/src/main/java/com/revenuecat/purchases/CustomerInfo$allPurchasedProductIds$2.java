...
public final class CustomerInfo$allPurchasedProductIds$2 extends o implements AbstractC6216a {
    ...
    public final Set<String> mo122invoke() {
        ...
        ArrayList arrayList = new ArrayList(AbstractC6583a.H1(nonSubscriptionTransactions, 10));
        for (Transaction transaction : nonSubscriptionTransactions) {
            arrayList.add(transaction.getProductIdentifier());
        }
        return AbstractC4273I.u2(t.P2(arrayList), this.this$0.getAllExpirationDatesByProduct().keySet());
    }
}
