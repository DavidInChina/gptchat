...
public final class StatsigClient$checkGate$1 extends o implements AbstractC6216a {
    final /* synthetic */ String $gateName;
    final /* synthetic */ x $result;
    final /* synthetic */ StatsigClient this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StatsigClient$checkGate$1(StatsigClient statsigClient, String str, x xVar) {
        super(0);
