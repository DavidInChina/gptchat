...
@AbstractC5158e(c = "com.statsig.androidsdk.StatsigNetworkImpl$initializeImpl$$inlined$postRequest$default$1", f = "StatsigNetwork.kt", l = {425, 427, 438, 447}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class StatsigNetworkImpl$initializeImpl$$inlined$postRequest$default$1 extends AbstractC5163j implements n {
    ...
    final /* synthetic */ B $statusCode$inlined;
    ...
    public StatsigNetworkImpl$initializeImpl$$inlined$postRequest$default$1(String str, String str2, Integer num, StatsigNetworkImpl statsigNetworkImpl, String str3, Diagnostics diagnostics, ContextType contextType, int i10, String str4, AbstractC4825e abstractC4825e, B b10) {
        ...
        this.$statusCode$inlined = b10;
    }

    @Override // pf.AbstractC5154a
    public final AbstractC4825e create(Object obj, AbstractC4825e abstractC4825e) {
        StatsigNetworkImpl$initializeImpl$$inlined$postRequest$default$1 statsigNetworkImpl$initializeImpl$$inlined$postRequest$default$1 = new StatsigNetworkImpl$initializeImpl$$inlined$postRequest$default$1(this.$api, this.$endpoint, this.$timeout, this.this$0, this.$eventsCount, this.$diagnostics, this.$contextType, this.$retries, this.$bodyString, abstractC4825e, this.$statusCode$inlined);
        statsigNetworkImpl$initializeImpl$$inlined$postRequest$default$1.L$0 = obj;
        return statsigNetworkImpl$initializeImpl$$inlined$postRequest$default$1;
    }

    public final Object invoke(F f6, AbstractC4825e abstractC4825e) {
        return ((StatsigNetworkImpl$initializeImpl$$inlined$postRequest$default$1) create(f6, abstractC4825e)).invokeSuspend(y.f36177a);
    }
                    ...
                    if (openConnection != null) {
                        ...
                        try {
                            try {
                                ...
                                Integer num3 = new Integer(responseCode);
                                ...
                                statsigNetworkImpl.endDiagnostics(diagnostics2, contextType, keyType, num3, str3, new Integer(i12), errorMessage);
                                if (200 > responseCode || responseCode > 299) {
                                    ...
                                    if (q.U2(iArr, responseCode)) {
                                        ...
                                        this.$statusCode$inlined.f37622Y = new Integer(responseCode);
