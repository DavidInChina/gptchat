...
public final class StatsigClient$getExperiment$1 extends o implements AbstractC6216a {
    final /* synthetic */ String $experimentName;
    final /* synthetic */ boolean $keepDeviceValue;
    final /* synthetic */ B $res;
    final /* synthetic */ StatsigClient this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StatsigClient$getExperiment$1(B b10, StatsigClient statsigClient, String str, boolean z10) {
        super(0);
        this.$res = b10;
    ...
    public final void mo122invoke() {
        ...
        if (store != null) {
            ...
            AbstractC3557B.Z(this.$res.f37622Y);
            StatsigClient.logExposure$default(statsigClient, str, (DynamicConfig) this.$res.f37622Y, false, 4, (Object) null);
            return;
        }
