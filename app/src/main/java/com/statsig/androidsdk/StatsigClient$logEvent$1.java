...
public final class StatsigClient$logEvent$1 extends o implements AbstractC6216a {
    ...
    @AbstractC5158e(c = "com.statsig.androidsdk.StatsigClient$logEvent$1$2", f = "StatsigClient.kt", l = {326}, m = "invokeSuspend")
    ...
    public static final class AnonymousClass2 extends AbstractC5163j implements n {
        ...
        public AnonymousClass2(StatsigClient statsigClient, LogEvent logEvent, AbstractC4825e abstractC4825e) {
        ...
        public final AbstractC4825e create(Object obj, AbstractC4825e abstractC4825e) {
            return new AnonymousClass2(this.this$0, this.$event, abstractC4825e);
        }

        public final Object invoke(F f6, AbstractC4825e abstractC4825e) {
            return ((AnonymousClass2) create(f6, abstractC4825e)).invokeSuspend(y.f36177a);
        }
        ...
        if (statsigUser != null) {
            ...
            if (!this.this$0.getOptions$build_release().getDisableCurrentActivityLogging()) {
                ...
                if (currentActivity != null) {
                    logEvent.setStatsigMetadata(P4.a.o0(new C3959i("currentPage", currentActivity.getClass().getSimpleName())));
                }
            }
            f6 = this.this$0.statsigScope;
            if (f6 != null) {
                l.O0(f6, null, null, new AnonymousClass2(this.this$0, logEvent, null), 3);
                return;
            } else {
