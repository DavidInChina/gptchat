...
public class D extends ImageView {
    ...
    public final r f43249h0;

    /* renamed from: i0  reason: collision with root package name */
    public final C f43250i0;

    /* renamed from: j0  reason: collision with root package name */
    public boolean f43251j0 = false;
    ...
    public final boolean hasOverlappingRendering() {
        if ((!(((ImageView) this.f43250i0.f43233Z).getBackground() instanceof RippleDrawable)) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        C c10 = this.f43250i0;
        if (c10 != null && drawable != null && !this.f43251j0) {
