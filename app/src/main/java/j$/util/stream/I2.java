...
final class I2 extends B {
    ...
    public final H0 T0(Spliterator spliterator, AbstractC3745c abstractC3745c, IntFunction intFunction) {
        ...
        double[] dArr = (double[]) ((D0) abstractC3745c.K0(spliterator, true, intFunction)).e();
        Arrays.sort(dArr);
        return new V0(dArr);
    }
    ...
    public final AbstractC3818q2 W0(int i10, AbstractC3818q2 abstractC3818q2) {
        ...
        return EnumC3759e3.SORTED.s(i10) ? abstractC3818q2 : EnumC3759e3.SIZED.s(i10) ? new AbstractC3783j2(abstractC3818q2) : new AbstractC3783j2(abstractC3818q2);
    }
}
