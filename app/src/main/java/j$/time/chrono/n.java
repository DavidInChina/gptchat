...
public final class n extends AbstractC3698a implements Serializable {

    /* renamed from: o  reason: collision with root package name */
    public static final n f34928o;
    private static final long serialVersionUID = 3127340209035924785L;

    /* renamed from: d  reason: collision with root package name */
    private final transient String f34929d = "Hijrah-umalqura";

    /* renamed from: e  reason: collision with root package name */
    private final transient String f34930e = "islamic-umalqura";

    /* renamed from: f  reason: collision with root package name */
    private volatile transient boolean f34931f;

    /* renamed from: g  reason: collision with root package name */
    private transient int[] f34932g;

    /* renamed from: h  reason: collision with root package name */
    private transient int f34933h;

    /* renamed from: i  reason: collision with root package name */
    private transient int f34934i;

    /* renamed from: j  reason: collision with root package name */
    private transient int f34935j;

    /* renamed from: k  reason: collision with root package name */
    private transient int f34936k;

    /* renamed from: l  reason: collision with root package name */
    private transient int f34937l;

    /* renamed from: m  reason: collision with root package name */
    private transient int f34938m;

    /* renamed from: n  reason: collision with root package name */
    private transient int f34939n;

    static {
        n nVar = new n();
        f34928o = nVar;
        AbstractC3698a.s(nVar, "Hijrah");
        AbstractC3698a.s(nVar, "islamic");
    }
    ...
    private void O() {
        if (!this.f34931f) {
            ...
            try {
                ...
                if (!this.f34930e.equals("islamic-umalqura")) {
                ...
                this.f34935j = 15600;
                this.f34933h = epochDay;
                int[] Q = Q(epochDay, hashMap);
                this.f34932g = Q;
                this.f34934i = Q[3612];
                for (int i11 = 1300; i11 < 1600; i11++) {
                    int Y7 = Y(i11, 12);
                    this.f34938m = Math.min(this.f34938m, Y7);
                    this.f34939n = Math.max(this.f34939n, Y7);
                }
                this.f34931f = true;
            } catch (Exception e10) {
                throw new RuntimeException("Unable to initialize HijrahCalendar: " + str, e10);
            }
        }
    }

    private int[] Q(int i10, HashMap hashMap) {
        int[] iArr = new int[3613];
        this.f34936k = Integer.MAX_VALUE;
        this.f34937l = Integer.MIN_VALUE;
        int i11 = 0;
        for (int i12 = 1300; i12 <= 1600; i12++) {
            ...
            while (i13 < 12) {
                ...
                i10 += i14;
                this.f34936k = Math.min(this.f34936k, i14);
                this.f34937l = Math.max(this.f34937l, i14);
                i13++;
                i11 = i15;
            }
        }
    ...
    public final j$.time.temporal.w F(j$.time.temporal.a aVar) {
        ...
        if (aVar instanceof j$.time.temporal.a) {
            switch (m.f34927a[aVar.ordinal()]) {
                case 1:
                    return j$.time.temporal.w.k(1L, this.f34936k, this.f34937l);
                case 2:
                    return j$.time.temporal.w.j(1L, this.f34939n);
                case 3:
                    return j$.time.temporal.w.j(1L, 5L);
                case 4:
                case 5:
                    return j$.time.temporal.w.j(R(0), R(this.f34932g.length - 1) - 1);
                case 6:
    ...
    public final boolean K(long j6) {
        O();
        return j6 >= ((long) R(0)) && j6 <= ((long) (R(this.f34932g.length - 1) - 1)) && Y((int) j6, 12) > 354;
    }
    ...
    public final int P(long j6) {
        if (j6 < R(0) || j6 > R(this.f34932g.length - 1) - 1) {
            throw new DateTimeException("Invalid Hijrah year: " + j6);
        }
        return (int) j6;
    }
    ...
    public final long T(int i10, int i11, int i12) {
        ...
        int i13 = (i11 - 1) + ((i10 * 12) - this.f34935j);
        if (i13 < 0 || i13 >= this.f34932g.length) {
            throw new DateTimeException("Invalid Hijrah date, year: " + i10 + ", month: " + i11);
        } else if (i12 >= 1 && i12 <= V(i10, i11)) {
            return (i12 - 1) + this.f34932g[i13];
        } else {
    ...
    public final int[] U(int i10) {
        O();
        if (i10 < this.f34933h || i10 >= this.f34934i) {
            throw new DateTimeException("Hijrah date out of range");
        }
        int binarySearch = Arrays.binarySearch(this.f34932g, i10);
        if (binarySearch < 0) {
            binarySearch = (-binarySearch) - 2;
        }
        return new int[]{R(binarySearch), ((this.f34935j + binarySearch) % 12) + 1, (i10 - this.f34932g[binarySearch]) + 1};
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final int V(int i10, int i11) {
        int i12 = (i11 - 1) + ((i10 * 12) - this.f34935j);
        if (i12 >= 0) {
            int[] iArr = this.f34932g;
            if (i12 < iArr.length) {
    ...
    public final ChronoLocalDate p() {
        ...
        return W6 instanceof p ? (p) W6 : p.T(this, W6.w(j$.time.temporal.a.EPOCH_DAY));
    }

    @Override // j$.time.chrono.k
    public final ChronoLocalDate q(TemporalAccessor temporalAccessor) {
        return temporalAccessor instanceof p ? (p) temporalAccessor : p.T(this, temporalAccessor.w(j$.time.temporal.a.EPOCH_DAY));
    }
