...
public class Camera2Session implements CameraSession {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        if (i10 != 4) {
                            if (i10 != 5) {
                                return android.gov.nist.core.a.e("Unknown camera error: ", i10);
                            }
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public /* synthetic */ void lambda$onConfigured$0(VideoFrame videoFrame) {
            ...
            VideoFrame videoFrame2 = new VideoFrame(AbstractC4503c.a((TextureBufferImpl) videoFrame.getBuffer(), Camera2Session.this.isCameraFrontFacing, -Camera2Session.this.cameraOrientation), Camera2Session.this.getFrameOrientation(), videoFrame.getTimestampNs());
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new C4501a(1, this));
    ...
    public int getFrameOrientation() {
        ...
        return (this.cameraOrientation + b10) % 360;
    }

    private void openCamera() {
        checkIsOnCameraThread();
        AbstractC4194d.z("Opening camera ", this.cameraId, TAG);
    ...
    private void start() {
        ...
        try {
            ...
            reportError(R.a.r("getCameraCharacteristics(): ", e10.getMessage()));
        }
    }
    ...
    public void stop() {
        AbstractC4194d.z("Stop camera2 session on camera ", this.cameraId, TAG);
        checkIsOnCameraThread();
