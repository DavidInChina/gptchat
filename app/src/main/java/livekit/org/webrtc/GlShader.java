...
public class GlShader {
    ...
    public GlShader(String str, String str2) {
        ...
        throw new RuntimeException(android.gov.nist.core.a.e("glCreateProgram() failed. GLES20 error: ", GLES20.glGetError()));
    }
    ...
    private static int compileShader(int i10, String str) {
        ...
        throw new RuntimeException(android.gov.nist.core.a.e("glCreateShader() failed. GLES20 error: ", GLES20.glGetError()));
    }
    ...
    public int getAttribLocation(String str) {
        ...
        if (i10 != -1) {
            ...
            throw new RuntimeException(android.gov.nist.core.a.A("Could not locate '", str, "' in program"));
        }
    ...
    public int getUniformLocation(String str) {
        ...
        if (i10 != -1) {
            ...
            throw new RuntimeException(android.gov.nist.core.a.A("Could not locate uniform '", str, "' in program"));
        }
        throw new RuntimeException("The program has been released");
    }
