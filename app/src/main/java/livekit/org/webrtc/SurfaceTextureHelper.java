...
public class SurfaceTextureHelper {
    ...
    public /* synthetic */ SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z10, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor, int i10) {
    ...
    public static SurfaceTextureHelper create(final String str, final EglBase.Context context, final boolean z10, final YuvConverter yuvConverter, final FrameRefMonitor frameRefMonitor) {
        ...
        return (SurfaceTextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable<SurfaceTextureHelper>() { // from class: livekit.org.webrtc.SurfaceTextureHelper.1
            ...
            public SurfaceTextureHelper call() {
                try {
                    return new SurfaceTextureHelper(context, handler, z10, yuvConverter, frameRefMonitor, 0);
                } catch (RuntimeException e10) {
                    String str2 = str;
                    Logging.e(SurfaceTextureHelper.TAG, str2 + " create failure", e10);
                    return null;
                }
            }
        });
    ...
    public void returnTextureFrame() {
        this.handler.post(new o(this, 0));
    }
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new o(this, 1));
    }
    ...
    public void setTextureSize(int i10, int i11) {
        if (i10 > 0) {
            if (i11 > 0) {
                ...
                this.handler.post(new p(this, i10, i11, 0));
                return;
            }
            throw new IllegalArgumentException(android.gov.nist.core.a.e("Texture height must be positive, but was ", i11));
        }
        throw new IllegalArgumentException(android.gov.nist.core.a.e("Texture width must be positive, but was ", i10));
    }
    ...
    public void stopListening() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new o(this, 2));
    }
    ...
    private SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z10, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor) {
        ...
        if (handler.getLooper().getThread() == Thread.currentThread()) {
            ...
            EglBase d10 = e.d(context, EglBase.CONFIG_PIXEL_BUFFER);
            this.eglBase = d10;
            try {
                ...
                surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: livekit.org.webrtc.q
