...
public class FileVideoCapturer implements VideoCapturer {
                ...
                if (read != -1) {
                    if (read == 10) {
                        ...
                        if (i10 % 2 != 1 && i11 % 2 != 1) {
                            ...
                            Logging.d(TAG, AbstractC0044t0.y("frame dim: (", i10, ", ", i11, Separators.RPAREN));
                            return;
                        }
                    ...
                    throw new RuntimeException(R.a.r("Found end of file before end of header for file: ", str));
                }
            }
        }
    ...
    public FileVideoCapturer(String str) {
        try {
            ...
            AbstractC4194d.z("Could not open video file: ", str, TAG);
            throw e10;
        }
    }
