...
public final class LivekitEgress$DirectFileOutput extends AbstractC2497d0 implements N0 {
    ...
    static {
        ...
        AbstractC2497d0.registerDefaultInstance(LivekitEgress$DirectFileOutput.class, livekitEgress$DirectFileOutput);
    }
    ...
    public static C3982J newBuilder() {
        return (C3982J) DEFAULT_INSTANCE.createBuilder();
    }

    public static LivekitEgress$DirectFileOutput parseDelimitedFrom(InputStream inputStream) {
        return (LivekitEgress$DirectFileOutput) AbstractC2497d0.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitEgress$DirectFileOutput parseFrom(ByteBuffer byteBuffer) {
        return (LivekitEgress$DirectFileOutput) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    public final Object dynamicMethod(EnumC2494c0 enumC2494c0, Object obj, Object obj2) {
        switch (enumC2494c0.ordinal()) {
            ...
            case 1:
                return null;
            case 2:
                return AbstractC2497d0.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0006\u0001\u0000\u0001\u0006\u0006\u0000\u0000\u0000\u0001\u0208\u0002<\u0000\u0003<\u0000\u0004<\u0000\u0005\u0007\u0006<\u0000", new Object[]{"output_", "outputCase_", "filepath_", LivekitEgress$S3Upload.class, LivekitEgress$GCPUpload.class, LivekitEgress$AzureBlobUpload.class, "disableManifest_", LivekitEgress$AliOSSUpload.class});
            case 3:
    ...
    public static C3982J newBuilder(LivekitEgress$DirectFileOutput livekitEgress$DirectFileOutput) {
        return (C3982J) DEFAULT_INSTANCE.createBuilder(livekitEgress$DirectFileOutput);
    }

    public static LivekitEgress$DirectFileOutput parseDelimitedFrom(InputStream inputStream, J j6) {
        return (LivekitEgress$DirectFileOutput) AbstractC2497d0.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, j6);
    }

    public static LivekitEgress$DirectFileOutput parseFrom(ByteBuffer byteBuffer, J j6) {
        return (LivekitEgress$DirectFileOutput) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, byteBuffer, j6);
    }

    public static LivekitEgress$DirectFileOutput parseFrom(AbstractC2534q abstractC2534q) {
        return (LivekitEgress$DirectFileOutput) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, abstractC2534q);
    }

    public static LivekitEgress$DirectFileOutput parseFrom(AbstractC2534q abstractC2534q, J j6) {
        return (LivekitEgress$DirectFileOutput) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, abstractC2534q, j6);
    }

    public static LivekitEgress$DirectFileOutput parseFrom(byte[] bArr) {
        return (LivekitEgress$DirectFileOutput) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static LivekitEgress$DirectFileOutput parseFrom(byte[] bArr, J j6) {
        return (LivekitEgress$DirectFileOutput) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, bArr, j6);
    }

    public static LivekitEgress$DirectFileOutput parseFrom(InputStream inputStream) {
        return (LivekitEgress$DirectFileOutput) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitEgress$DirectFileOutput parseFrom(InputStream inputStream, J j6) {
        return (LivekitEgress$DirectFileOutput) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, inputStream, j6);
    }

    public static LivekitEgress$DirectFileOutput parseFrom(AbstractC2543v abstractC2543v) {
        return (LivekitEgress$DirectFileOutput) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, abstractC2543v);
    }

    public static LivekitEgress$DirectFileOutput parseFrom(AbstractC2543v abstractC2543v, J j6) {
        return (LivekitEgress$DirectFileOutput) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, abstractC2543v, j6);
    }
}
