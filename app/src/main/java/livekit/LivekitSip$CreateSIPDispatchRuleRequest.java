...
public final class LivekitSip$CreateSIPDispatchRuleRequest extends AbstractC2497d0 implements N0 {
    ...
    static {
        ...
        AbstractC2497d0.registerDefaultInstance(LivekitSip$CreateSIPDispatchRuleRequest.class, livekitSip$CreateSIPDispatchRuleRequest);
    }
    ...
    public static LivekitSip$CreateSIPDispatchRuleRequest parseDelimitedFrom(InputStream inputStream) {
        return (LivekitSip$CreateSIPDispatchRuleRequest) AbstractC2497d0.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitSip$CreateSIPDispatchRuleRequest parseFrom(ByteBuffer byteBuffer) {
        return (LivekitSip$CreateSIPDispatchRuleRequest) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    public final Object dynamicMethod(EnumC2494c0 enumC2494c0, Object obj, Object obj2) {
        switch (enumC2494c0.ordinal()) {
            ...
            case 1:
                return null;
            case 2:
                return AbstractC2497d0.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0001\u0000\u0001\t\u0002\u021a\u0003\u0007", new Object[]{"rule_", "trunkIds_", "hidePhoneNumber_"});
            case 3:
    ...
    public static P3 newBuilder(LivekitSip$CreateSIPDispatchRuleRequest livekitSip$CreateSIPDispatchRuleRequest) {
        return (P3) DEFAULT_INSTANCE.createBuilder(livekitSip$CreateSIPDispatchRuleRequest);
    }

    public static LivekitSip$CreateSIPDispatchRuleRequest parseDelimitedFrom(InputStream inputStream, J j6) {
        return (LivekitSip$CreateSIPDispatchRuleRequest) AbstractC2497d0.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, j6);
    }

    public static LivekitSip$CreateSIPDispatchRuleRequest parseFrom(ByteBuffer byteBuffer, J j6) {
        return (LivekitSip$CreateSIPDispatchRuleRequest) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, byteBuffer, j6);
    }

    public static LivekitSip$CreateSIPDispatchRuleRequest parseFrom(AbstractC2534q abstractC2534q) {
        return (LivekitSip$CreateSIPDispatchRuleRequest) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, abstractC2534q);
    }

    public static LivekitSip$CreateSIPDispatchRuleRequest parseFrom(AbstractC2534q abstractC2534q, J j6) {
        return (LivekitSip$CreateSIPDispatchRuleRequest) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, abstractC2534q, j6);
    }

    public static LivekitSip$CreateSIPDispatchRuleRequest parseFrom(byte[] bArr) {
        return (LivekitSip$CreateSIPDispatchRuleRequest) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static LivekitSip$CreateSIPDispatchRuleRequest parseFrom(byte[] bArr, J j6) {
        return (LivekitSip$CreateSIPDispatchRuleRequest) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, bArr, j6);
    }

    public static LivekitSip$CreateSIPDispatchRuleRequest parseFrom(InputStream inputStream) {
        return (LivekitSip$CreateSIPDispatchRuleRequest) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LivekitSip$CreateSIPDispatchRuleRequest parseFrom(InputStream inputStream, J j6) {
        return (LivekitSip$CreateSIPDispatchRuleRequest) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, inputStream, j6);
    }

    public static LivekitSip$CreateSIPDispatchRuleRequest parseFrom(AbstractC2543v abstractC2543v) {
        return (LivekitSip$CreateSIPDispatchRuleRequest) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, abstractC2543v);
    }

    public static LivekitSip$CreateSIPDispatchRuleRequest parseFrom(AbstractC2543v abstractC2543v, J j6) {
        return (LivekitSip$CreateSIPDispatchRuleRequest) AbstractC2497d0.parseFrom(DEFAULT_INSTANCE, abstractC2543v, j6);
    }
}
