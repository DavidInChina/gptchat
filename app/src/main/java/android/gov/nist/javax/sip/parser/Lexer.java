    ...
    public void selectLexer(String str) {
        ...
        if (concurrentHashMap2 == null) {
            ...
            if (str.equals("method_keywordLexer")) {
                ...
                addKeyword(TokenNames.f24314K, 2068);
                addKeyword(TokenNames.f24310C, TokenTypes.CONTENT_TYPE);
                addKeyword(TokenNames.f24311E, TokenTypes.CONTENT_ENCODING);
                addKeyword(TokenNames.f24312F, TokenTypes.FROM);
                addKeyword(TokenNames.f24313I, TokenTypes.CALL_ID);
                addKeyword(TokenNames.f24316M, TokenTypes.CONTACT);
                addKeyword(TokenNames.f24315L, TokenTypes.CONTENT_LENGTH);
                addKeyword(TokenNames.S, TokenTypes.SUBJECT);
                addKeyword(TokenNames.T, TokenTypes.TO);
                addKeyword(TokenNames.f24319U, TokenTypes.ALLOW_EVENTS);
                addKeyword(TokenNames.f24320V, TokenTypes.VIA);
                addKeyword(TokenNames.f24318R, TokenTypes.REFER_TO);
                addKeyword(TokenNames.f24317O, TokenTypes.EVENT);
                addKeyword(TokenNames.f24321X, TokenTypes.SESSIONEXPIRES_TO);
            ...
            ConcurrentHashMap<String, Integer> putIfAbsent = concurrentHashMap.putIfAbsent(str, concurrentHashMap3);
            if (putIfAbsent != null) {
